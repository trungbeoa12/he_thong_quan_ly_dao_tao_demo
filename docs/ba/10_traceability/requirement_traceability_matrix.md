...
| Yêu cầu nghiệp vụ | URD Requirement | SRS Requirement | API | Bảng database | Màn hình UI | Test Case |
| --- | --- | --- | --- | --- | --- | --- |
...
Mục tiêu của RTM là giúp BA thấy mỗi requirement được hiện thực hóa qua UI, API, database và test case như thế nào.
